...
class SingleMarkovTest(TestCase):
    def test_initializer(self):
        with open('MarkovMerge/sources/hamlet.txt') as hamlet:
    ...
    def test_generate_text(self):
        with open('MarkovMerge/sources/trump.txt') as trump:
    ...
    def test_get_from_db(self):
        with open('MarkovMerge/sources/frankenstein.txt') as frankenstein:
