...
class SingleSequenceSerializer(serializers.HyperlinkedModelSerializer):
    '''Serializer for a sequence generated by a single markov model
    '''
    class Meta:
        model = SingleMarkov
        fields = ['url', 'random_sequence']
